...
const Step1Setup = ({ onStart }) => {
  ...
  const handleStart = async () => {
    SetLoading(true);
    try {
      const result = await axios.post(backendUrl + "/api/interview/generate-questions", {role,experience, mode, resumeText, project, skills}, {withCredentials: true});
      ...
      <div className="w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden">
        ...
        >
          ...
          <p className="text-gray-600 mb-10">
            Practical real interview scenarios powered by AI. Improve
            comminications, technical skills and confidence.
          </p>
          ...
          <div className="space-y-6">
            ...
            {!analyseDone && (
              <motion.div
                ...
                className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center cursor-pointer hover:border-gray-500 hover:bg-green-50 transition"
              >
                <FaFileUpload className="text-4xl mx-auto text-green-600 mb-6" />
